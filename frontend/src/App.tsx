        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2 bg-slate-950/60 px-3 py-1.5 rounded-lg border border-slate-800 text-xs">
              ...
              >
                <option value="gemini-3.6-flash" className="bg-slate-900 text-slate-100">Gemini 3.6 Flash</option>
                <option value="gemini-3.1-flash-lite" className="bg-slate-900 text-slate-100">Gemini 3.1 Flash-Lite</option>
                <option value="gemini-2.5-pro" className="bg-slate-900 text-slate-100">Gemini 2.5 Pro</option>
              </select>
            </div>
